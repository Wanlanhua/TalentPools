...
@WebFilter(filterName="Loginfilter",value= {"/*"},initParams= {
		@WebInitParam(name="nologin",value="login.html;register_step1.html;register_step2.html;register_step3.html;registeredphotos;register_step4.html;registered;Login;.jpg;"
				+ ".png;.jpeg;.css;.js;jiaoyan;Daochu1;Daochu2")
})
